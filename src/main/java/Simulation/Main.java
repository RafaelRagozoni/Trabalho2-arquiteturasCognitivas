...
public class Main
{
    ...
    public Main() {
        ...
        try
        {
            // NativeUtils.loadFileFromJar("/rules/placeholder2.soar");
            // String soarRulesPath = "placeholder2.soar";
            NativeUtils.loadFileFromJar("/rules/rules-plan.soar");
            String soarRulesPath = "rules-plan.soar";
